...
#%%
train_credit = pd.read_csv('train_gen_credit_sca.csv')
#%%
test_credit = pd.read_csv('test_gen_credit_sca.csv')
# In[6]:
final = pd.get_dummies(train_credit,columns = [ 'income_type',
...
#%%
test_credit.to_csv('credit_gen예측완_cp.csv',encoding = 'cp949')
test_credit.to_csv('credit_gen예측완.csv')