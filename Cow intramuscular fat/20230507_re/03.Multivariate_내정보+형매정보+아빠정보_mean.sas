...
/* Logistic regression for 7, 8, 9 AUC - 0.77*/
proc logistic data=TRAINSET plots=ROC;
class FARM_LEVEL (ref='3') GENDER (ref='거세');
...
/* target 9 */
PR_4 = -8.1408+ (0.0348*SEX) + (1.2836 *F1) + (-0.1612*F2) + (4.1493*k1) + (3.016*k2) 
		+ (-0.00779*SL_M) + (0.00719*S_W) 
		+ (-0.00253*S_M_W) + (0.00414* S_M_I) +(-0.00985*S_F_M)+ (0.1969*S_T_M) + (-0.0524*S_C); 
...
/* target 9 */
PR_5 =  -7.3973 + (0.0348*SEX) + (1.2843 *F1) + (-0.1614*F2) + (1.1361*KPN_MEAN_LEVEL) 
		+ (-0.00779*SL_M) + (0.00719*S_W) 	
		+ (-0.00253*S_M_W) + (0.00414* S_M_I) +(-0.00983*S_F_M)+ (0.1969*S_T_M) + (-0.0524*S_C); 
...
/* target 9 */
PR_6 =  -9.1614+ (0.0172*SEX) + (1.2447 *F1) + (-0.1553*F2) + (0.7428*KPN_MEAN) 
		+ (-0.00548*SL_M) + (0.00703*S_W) 	
		+ (-0.00269*S_M_W) + (0.00395* S_M_I) +(-0.0092*S_F_M)+ (0.1939*S_T_M) + (-0.0374*S_C); 
