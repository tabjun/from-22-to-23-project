...
/* target 9 */
PR_4 = -5.0511+ (0.0364*SEX) + (1.2869 *F1) + (-0.1626*F2) + (1.0507*k1) + (-0.0716*k2) 
		+ (-0.00805*SL_M) + (0.0072*S_W) 
		+ (-0.00253*S_M_W) + (0.0042* S_M_I) +(-0.00989*S_F_M)+ (0.1971*S_T_M) + (-0.0533*S_C); 
...
/* target 9 */
PR_5 =  -7.3649 + (0.0364*SEX) + (1.2869*F1) + (-0.1626*F2) + (1.1212*KPN_MEDIAN_LEVEL) 
		+ (-0.00806*SL_M) + (0.0072*S_W) 	
		+ (-0.00253*S_M_W) + (0.0042* S_M_I) +(-0.0099*S_F_M)+ (0.197*S_T_M) + (-0.0533*S_C); 
...
/* target 9 */
PR_6 =  -9.3578+ (0.0168*SEX) + (1.2425*F1) + (-0.1522*F2) + (0.7588*KPN_MEDIAN) 
		+ (-0.00586*SL_M) + (0.00704*S_W) 	
		+ (-0.0027*S_M_W) + (0.00388* S_M_I) +(-0.00879*S_F_M)+ (0.1941*S_T_M) + (-0.0414*S_C); 
