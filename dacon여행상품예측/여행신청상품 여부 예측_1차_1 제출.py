...
#%%
# durationofpitch결측치 처리
test['group_pitch_10'] = test['group_pitch_10'].fillna('5이상 15미만')
print(f"pitch결측치:{test['group_pitch_10'].isnull().sum()}");print('\t')
print(test['group_pitch_10'].value_counts())
#%%
...
#%%
#블렌딩 모델
bl = blend_models(estimator_list=top5_model,fold=10,method='soft',optimize='Accuracy')
#%%
#모델 튜닝
...
final_et = finalize_model(tuned_et)
#%%
pred_et.to_csv('C:\\Users\\215-05\\Desktop\\여행여부 예측\\et_robust.csv',
               columns = ['Label'])