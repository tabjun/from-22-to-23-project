...
#%%
#정확도기준 모델 형성 및 성능 비교
top5_model = compare_models(sort='Accuracy',fold=10,n_select = 5)
#%%
print(top5_model)
#%%
#f1스코어
top5_model_f1 = compare_models(fold=10, n_select = 5, sort='F1')
print(top5_model_f1)
# 정밀도
top5_model_prec = compare_models(fold=10, n_select = 5, sort='Precision')
...
#%%
#블렌딩 모델
bl = blend_models(estimator_list=['et','xgboost','lightgbm'],optimize='Accuracy')
#%%
#모델 튜닝
tuned_rf = tune_model(rf,fold = 5 , optimize='Accuracy',choose_better=True)
tuned_et = tune_model(et,fold = 5 , optimize='Accuracy',choose_better=True)
#%%
#엑스트라 트리
final_et = finalize_model(tuned_et)
pred_et = predict_model(final_et, data = test)
#%%
final_bl = finalize_model(bl)
pred_bl = predict_model(final_bl)
#%%
# 랜포 prec 1등
...
final_et = finalize_model(tuned_et)
#%%
pred_et.to_csv('C:\\Users\\215-05\\Desktop\\여행여부 예측\\et_robust_gr5.csv',
               columns = ['Label'])
#%%
pred_bl.to_csv('C:\\Users\\215-05\\Desktop\\여행여부 예측\\bl_robust_gr5.csv',
               columns = ['Label'])
#%%
